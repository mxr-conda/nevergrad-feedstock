...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nevergrad-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9470&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nevergrad-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nevergrad` can be installed with:

```
conda install nevergrad
```

It is possible to list all of the versions of `nevergrad` available on your platform with:
